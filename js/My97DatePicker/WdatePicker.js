...
var $dp=null;$=function(id){return document.getElementById(id);}
...
while(obj=obj.offsetParent){if(obj.style.position=='absolute'||obj.style.position=='relative'||(obj.style.overflow!='visible'&&obj.style.overflow!='')){break;}
top+=obj.offsetTop;
left+=obj.offsetLeft;
...
if(!this.top.Document.prototype.attachEvent){this.top.Document.prototype.attachEvent=Document.prototype.attachEvent;}}
...
this.dd.style.cssText='position:absolute;z-index:197;';
this.dd.obj=this;
...
var ddHeight=Math.max(parseInt(this.dd.offsetHeight),30);
...
if(!this.win.document.hasUnload){this.win.document.attachEvent('onbeforeunload',function(){$dp.style.display='none';});
